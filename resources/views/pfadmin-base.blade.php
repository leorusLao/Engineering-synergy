...
@include('admin-bu-sidebar')
<aside class="right-side">
<!-- Main content -->
   <section class="content-header">

   @if(Session::get('USERINFO')->buId > 0)
     <h3 class="text-center text-warning">{{Lang::get('mowork.bu_management')}}</h3>
	 <h4 class="text-center">
	   {{Session::get('USERINFO')->buName}} - {{Session::get('USERINFO')->buDomain}}
	 </h4>
   @endif
