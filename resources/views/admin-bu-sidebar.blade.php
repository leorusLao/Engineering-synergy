		...
		<div class="page-sidebar sidebar-nav dropdown">
				...
				<li>
 				   <div id='me8' class="have text-center"><a href="#"> 
						<span class="title">{{Lang::get('mowork.bu_config')}}</span> <span class="fa arrow"></span>
					</a>
				   </div>
		
				   <ul class="sub-menu">
  	  	        		     <li><a href="/pfadmin/node-type">{{Lang::get('mowork.node_type')}}</a></li>
		                     <li><a href="/pfadmin/node-list">{{Lang::get('mowork.plan_node_list')}}</a></li>
