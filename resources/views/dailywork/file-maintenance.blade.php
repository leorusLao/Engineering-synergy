		...
		<div class="panel panel-primary">
	  		...
	  		<div class="panel-body">
	  			<div class="row">
	  					...
	  					<div class="margin-b10"><b>{{Lang::get('mowork.project_number')}}</b> {{$basinfo->proj_code}}&nbsp;&nbsp;&nbsp;<b>{{Lang::get('mowork.part_name')}}</b> {{$basinfo->part_name}}</div>
			...
			<tr>
			    ...
			    <th nowrap='nowrap' class="text-center">{{Lang::get('mowork.maintenance')}}</th>
				            ...
				            @foreach($rows as $row)
				             ...
				             @else 
				             <tr>
				             <td></td><td>{{$row->title}}</td><td>{{$row->fsize}}</td><td>{{substr($row->created_at,0,10)}}</td>
