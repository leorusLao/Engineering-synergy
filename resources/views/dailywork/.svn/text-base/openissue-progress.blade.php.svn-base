	        ...
	        <div class="todolist_list adds" style="border-bottom:0px;">
	            <form role="form" id="main_input_box" class="form-inline">
	                ...
	                <div class="form-group col-md-3">
					    ...
					    &nbsp;&nbsp;<button type="button" class="btn btn-raised btn-success btn-large" data-toggle="modal" data-target="#company_department">{{Lang::get('mowork.select')}}</button>
					</div>
	                ...
	                <div class="form-group col-md-3">	               
					    ...
					    &nbsp;&nbsp;<button type="button" class="btn btn-raised btn-success btn-large" data-toggle="modal" data-target="#company_user">{{Lang::get('mowork.select')}}</button>
	                </div>
	                ...
	                <div class="form-group col-md-3">	               
					    ...
					    &nbsp;&nbsp;<button type="button" class="btn btn-raised btn-success btn-large" data-toggle="modal" data-target="#company_tcr">{{Lang::get('mowork.select')}}</button>
	                </div>
...
$('.btn_save').on('click', function(){
    $('#form_project').submit(function(){
		...
		var data = project + str_lj + str_pic + str_delete;
		if(num == 1){
	        $.ajax({
	            type: 'post',
	            data: data,
