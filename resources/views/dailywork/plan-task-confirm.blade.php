...
<div class="col-xs-12 col-sm-10 col-sm-offset-1">
	...
	<table class="table data-table table-bordered" id="tb1">
		...
		<tbody>
            ...
            <tr>
				...
				<td>{{ Lang::get('mowork.approval_person') }}: {{isset($approver->fullname)?$approver->fullname:''}}</td> 
		 	</tr>
		 	<tr>
    ...
    <table class="table data-table table-bordered" id="tb2">
		...
		<tbody>
	      ...
	      <form action="/dashboard/workboard/plan-task-confirm/{{$token}}/{{$row->task_id}}" method="post">
